      ...
      <tbody>
        <?php foreach ($data['daftar_pelanggaran'] as $no => $pelanggaran): ?>
          ...
          <tr class="border-b border-gray-200 hover:bg-gray-50">
            ...
            <td class="py-4 px-2">
              <img src="<?= BASEURL ?>/uploads/<?= $pelanggaran['bukti'] ?>"
            ...
            <td class="py-4 px-2">
              ...
              <div class="flex flex-col sm:flex-row gap-2">
                <a href="<?= BASEURL; ?>/guru/edit_pelanggaran/<?= $pelanggaran['NIS'] ?>/<?= $pelanggaran['ID'] ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center gap-1 font-semibold">
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                  </svg>
                  Ubah
                </a>
                <a href="<?= BASEURL; ?>/guru/hapus_pelanggaran/<?= $data['siswa']['NIS'] ?>/<?= $pelanggaran['ID'] ?>" id="hapus" class="text-red-600 hover:text-red-800 text-sm font-medium flex items-center gap-1 font-semibold">
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
